...
while goodToGo:        # Begin while loop
    ...
    lastName = str(input("\nEnter the last name. "))   # Get last name or ZZZ to stop loop

    if lastName.upper() == zStop:                          # Check for ZZZ
        print("\nThank you for using this program.\n\n ")  # ZZZ found. Display exit message
        ...
        if GPA >= dList:                                            # If GPA equal or greater 3.5
            print("\nThis student has made the Dean\'s List. ")       # Print deans list message and get next student

        elif GPA >= hList:                                          # if GPA equal or greater 3.25
            print("\nThis student has made the Honor Roll.")          # Print honor roll message and get next student

        else:                                                       # GPA less than 3.25
            print("\nThis student does not qualify for either list.") # print not qualified message and get next student
